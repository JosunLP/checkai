...
const DICTIONARIES: Record<string, Record<string, string>> = {
  en: {
    ...
    'lang.label': 'Language',
    'engine.title': 'Live Engine',
    'engine.run': 'Evaluate',
    'engine.auto': 'Auto',
    'engine.arrow': 'Best-move arrow',
    'engine.movetime': 'Time (ms)',
    'engine.multipv': 'Lines',
    'engine.threads': 'Threads',
    'engine.idle': "Press Evaluate to see the engine's verdict.",
    'engine.thinking': 'Thinking…',
    'engine.depth': 'depth %{depth}/%{seldepth}',
    'engine.nodes': '%{nodes} nodes · %{nps} n/s',
    'engine.hashfull': 'hash %{permille}‰',
    'engine.book': 'Opening book',
    'engine.tablebase': 'Tablebase %{config}: %{wdl} (%{source})',
    'engine.eval_aria': 'Evaluation %{score}',
  },
  ...
  de: {
    ...
    'engine.title': 'Live-Engine',
    'engine.run': 'Bewerten',
    'engine.auto': 'Automatisch',
    'engine.arrow': 'Pfeil für besten Zug',
    'engine.movetime': 'Zeit (ms)',
    'engine.multipv': 'Varianten',
    'engine.threads': 'Threads',
    'engine.idle': 'Auf „Bewerten“ klicken, um das Urteil der Engine zu sehen.',
    'engine.thinking': 'Rechnet…',
    'engine.depth': 'Tiefe %{depth}/%{seldepth}',
    'engine.nodes': '%{nodes} Knoten · %{nps} K/s',
    'engine.hashfull': 'Hash %{permille}‰',
    'engine.book': 'Eröffnungsbuch',
    'engine.tablebase': 'Endspieldatenbank %{config}: %{wdl} (%{source})',
    'engine.eval_aria': 'Bewertung %{score}',
  },
  ...
  fr: {
    ...
    'lang.label': 'Langue',
    'engine.title': 'Moteur en direct',
    'engine.run': 'Évaluer',
    'engine.auto': 'Auto',
    'engine.arrow': 'Flèche du meilleur coup',
    'engine.movetime': 'Temps (ms)',
    'engine.multipv': 'Variantes',
    'engine.threads': 'Threads',
    'engine.idle': 'Cliquez sur Évaluer pour voir le verdict du moteur.',
    'engine.thinking': 'Réflexion…',
    'engine.depth': 'profondeur %{depth}/%{seldepth}',
    'engine.nodes': '%{nodes} nœuds · %{nps} n/s',
    'engine.hashfull': 'hash %{permille}‰',
    'engine.book': "Livre d'ouvertures",
    'engine.tablebase': 'Base de finales %{config} : %{wdl} (%{source})',
    'engine.eval_aria': 'Évaluation %{score}',
  },
  ...
  es: {
    ...
    'lang.label': 'Idioma',
    'engine.title': 'Motor en vivo',
    'engine.run': 'Evaluar',
    'engine.auto': 'Auto',
    'engine.arrow': 'Flecha de la mejor jugada',
    'engine.movetime': 'Tiempo (ms)',
    'engine.multipv': 'Líneas',
    'engine.threads': 'Hilos',
    'engine.idle': 'Pulsa Evaluar para ver el veredicto del motor.',
    'engine.thinking': 'Pensando…',
    'engine.depth': 'profundidad %{depth}/%{seldepth}',
    'engine.nodes': '%{nodes} nodos · %{nps} n/s',
    'engine.hashfull': 'hash %{permille}‰',
    'engine.book': 'Libro de aperturas',
    'engine.tablebase': 'Base de finales %{config}: %{wdl} (%{source})',
    'engine.eval_aria': 'Evaluación %{score}',
  },
  ...
  'zh-CN': {
    ...
    'engine.auto': '自动',
    'engine.arrow': '最佳着法箭头',
    'engine.movetime': '时间（毫秒）',
    'engine.multipv': '变例数',
    'engine.threads': '线程',
    'engine.idle': '点击“评估”查看引擎结论。',
    'engine.thinking': '思考中…',
    'engine.depth': '深度 %{depth}/%{seldepth}',
    'engine.nodes': '%{nodes} 节点 · %{nps} 节点/秒',
    'engine.hashfull': '置换表 %{permille}‰',
    'engine.book': '开局库',
    'engine.tablebase': '残局库 %{config}：%{wdl}（%{source}）',
    'engine.eval_aria': '评估 %{score}',
  },
  ...
  ja: {
    ...
    'lang.label': '言語',
    'engine.title': 'ライブエンジン',
    'engine.run': '評価',
    'engine.auto': '自動',
    'engine.arrow': '最善手の矢印',
    'engine.movetime': '時間（ms）',
    'engine.multipv': '候補手数',
    'engine.threads': 'スレッド',
    'engine.idle': '「評価」を押すとエンジンの判断が表示されます。',
    'engine.thinking': '思考中…',
    'engine.depth': '深さ %{depth}/%{seldepth}',
    'engine.nodes': '%{nodes} ノード · %{nps} n/s',
    'engine.hashfull': 'ハッシュ %{permille}‰',
    'engine.book': 'オープニングブック',
    'engine.tablebase': 'テーブルベース %{config}: %{wdl}（%{source}）',
    'engine.eval_aria': '評価 %{score}',
  },
  ...
  pt: {
    ...
    'lang.label': 'Idioma',
    'engine.title': 'Motor ao vivo',
    'engine.run': 'Avaliar',
    'engine.auto': 'Auto',
    'engine.arrow': 'Seta do melhor lance',
    'engine.movetime': 'Tempo (ms)',
    'engine.multipv': 'Linhas',
    'engine.threads': 'Threads',
    'engine.idle': 'Clique em Avaliar para ver o veredicto do motor.',
    'engine.thinking': 'A pensar…',
    'engine.depth': 'profundidade %{depth}/%{seldepth}',
    'engine.nodes': '%{nodes} nós · %{nps} n/s',
    'engine.hashfull': 'hash %{permille}‰',
    'engine.book': 'Livro de aberturas',
    'engine.tablebase': 'Base de finais %{config}: %{wdl} (%{source})',
    'engine.eval_aria': 'Avaliação %{score}',
  },
  ...
  ru: {
    ...
    'lang.label': 'Язык',
    'engine.title': 'Движок вживую',
    'engine.run': 'Оценить',
    'engine.auto': 'Авто',
    'engine.arrow': 'Стрелка лучшего хода',
    'engine.movetime': 'Время (мс)',
    'engine.multipv': 'Варианты',
    'engine.threads': 'Потоки',
    'engine.idle': 'Нажмите «Оценить», чтобы увидеть вердикт движка.',
    'engine.thinking': 'Думает…',
    'engine.depth': 'глубина %{depth}/%{seldepth}',
    'engine.nodes': '%{nodes} узлов · %{nps} у/с',
    'engine.hashfull': 'хеш %{permille}‰',
    'engine.book': 'Дебютная книга',
    'engine.tablebase': 'Таблицы окончаний %{config}: %{wdl} (%{source})',
    'engine.eval_aria': 'Оценка %{score}',
  },
};
