...
1. **Build stage** — Uses an official Rust image (as defined in the Dockerfile / project toolchain) to compile the release binary with dependency caching.
...
# Specific version
docker pull ghcr.io/josunlp/checkai:1.0.1
